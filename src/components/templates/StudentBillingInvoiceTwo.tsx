...
export function StudentBillingInvoiceTwo({ data }: { data: InvoiceData }) {
  ...
  return (
    <TemplateFrame brandColor={"#2563EB"}>
      ...
      <section className="mb-5 grid grid-cols-4 gap-2 rounded-md bg-gray-50 p-3 text-[10px]">
        <div><b>Template</b><br />Student Billing Invoice Two</div>
...
export default StudentBillingInvoiceTwo;
