...
export function BusBookingInvoiceTwo({ data }: { data: InvoiceData }) {
  ...
  return (
    <TemplateFrame brandColor={"#1D4ED8"}>
      ...
      <section className="mb-5 grid grid-cols-4 gap-2 rounded-md bg-gray-50 p-3 text-[10px]">
        <div><b>Template</b><br />Bus Booking Invoice Two</div>
...
export default BusBookingInvoiceTwo;
