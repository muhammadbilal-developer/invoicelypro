...
export function StadiumSeatBookingInvoice({ data }: { data: InvoiceData }) {
  ...
  return (
    <TemplateFrame brandColor={"#2563EB"}>
      ...
      <section className="mb-5 grid grid-cols-2 gap-2 rounded-md bg-gray-50 p-3 text-[10px]">
        <div><b>Template</b><br />Stadium Seat Booking Invoice</div>
      ...
      <ItemsTable data={data} items={data.items} columns={["sl","description","price","qty","total"]} variant="striped" />
...
export default StadiumSeatBookingInvoice;
