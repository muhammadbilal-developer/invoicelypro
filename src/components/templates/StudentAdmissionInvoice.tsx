...
export function StudentAdmissionInvoice({ data }: { data: InvoiceData }) {
  ...
  return (
    <TemplateFrame brandColor={"#7C3AED"}>
      ...
      <section className="mb-5 grid grid-cols-4 gap-2 rounded-md bg-[#f8fafc] p-3 text-[10px]">
        <div><b>Template</b><br />Student Admission Invoice</div>
      ...
      <ItemsTable data={data} items={data.items} columns={["sl","description","qty","total"]} variant="outlined" />
...
export default StudentAdmissionInvoice;
