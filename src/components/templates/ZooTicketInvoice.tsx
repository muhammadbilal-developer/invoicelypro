...
export function ZooTicketInvoice({ data }: { data: InvoiceData }) {
  ...
  return (
    <TemplateFrame brandColor={"#16A34A"}>
      ...
      <section className="mb-5 grid grid-cols-2 gap-2 rounded-md bg-[#f8fafc] p-3 text-[10px]">
        <div><b>Template</b><br />Zoo Ticket Invoice</div>
...
export default ZooTicketInvoice;
