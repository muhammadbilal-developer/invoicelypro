...
export function RoofingServicesInvoice({ data }: { data: InvoiceData }) {
  ...
  return (
    <TemplateFrame brandColor={"#EA580C"}>
      ...
      <section className="mb-5 grid grid-cols-4 gap-2 rounded-md bg-gray-50 p-3 text-[10px]">
        <div><b>Template</b><br />Roofing Services Invoice</div>
...
export default RoofingServicesInvoice;
