...
export function RestaurantBillInvoiceTwo({ data }: { data: InvoiceData }) {
  ...
  return (
    <TemplateFrame brandColor={"#111827"}>
      ...
      <section className="mb-5 grid grid-cols-2 gap-2 rounded-md bg-[#f8fafc] p-3 text-[10px]">
        <div><b>Template</b><br />Restaurant Bill Invoice Two</div>
        <div><b>Status</b><br />Confirmed</div>
        </section>

      <ItemsTable data={data} items={data.items} columns={["sl","description","price","qty","total"]} variant="accent-header" />
...
export default RestaurantBillInvoiceTwo;
