...
export function HotelBookingInvoiceTwo({ data }: { data: InvoiceData }) {
  ...
  return (
    <TemplateFrame brandColor={"#0F1A12"}>
      ...
      <section className="mb-5 grid grid-cols-4 gap-2 rounded-md bg-[#f8fafc] p-3 text-[10px]">
        <div><b>Template</b><br />Hotel Booking Invoice Two</div>
...
export default HotelBookingInvoiceTwo;
