...
export function PhotostudioInvoice({ data }: { data: InvoiceData }) {
  ...
  return (
    <TemplateFrame brandColor={"#0F172A"}>
      ...
      <section className="mb-5 grid grid-cols-4 gap-2 rounded-md bg-[#f8fafc] p-3 text-[10px]">
        <div><b>Template</b><br />Photostudio Invoice</div>
...
export default PhotostudioInvoice;
