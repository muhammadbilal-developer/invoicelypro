...
export function TrainBookingInvoice({ data }: { data: InvoiceData }) {
  ...
  return (
    <TemplateFrame brandColor={"#0F766E"}>
      ...
      <section className="mb-5 grid grid-cols-2 gap-2 rounded-md bg-[#f8fafc] p-3 text-[10px]">
        <div><b>Template</b><br />Train Booking Invoice</div>
...
export default TrainBookingInvoice;
